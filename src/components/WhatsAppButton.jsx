...
const WhatsAppButton = ({ message = "Hi, I need help with your services.", className = "" }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999]">
      <motion.button
        onClick={handleClick}
        className={`relative bg-[#25D366] text-white rounded-full p-4 shadow-2xl hover:bg-[#20BA5A] transition-all duration-300 flex items-center justify-center ${className}`}
        initial={{ scale: 0 }}
        animate={{
          scale: [1, 1.05, 1],
          y: [0, -8, 0],
